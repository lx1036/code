    ...
    DeprecatedDatePipe.prototype.transform = function (value, pattern) {
        ...
        if (!isDate(date)) {
            ...
            if ((typeof value === 'string') && (match = value.match(format_date_1.ISO8601_DATE_REGEX))) {
                ...
                throw invalid_pipe_argument_error_1.invalidPipeArgumentError(DeprecatedDatePipe, value);
            }
        }
        return intl_1.DateFormatter.format(date, this._locale, DeprecatedDatePipe._ALIASES[pattern] || pattern);
    };
    /** @internal */
