...
var LowerCasePipe = /** @class */ (function () {
    ...
    LowerCasePipe.prototype.transform = function (value) {
        ...
        if (typeof value !== 'string') {
            throw invalid_pipe_argument_error_1.invalidPipeArgumentError(LowerCasePipe, value);
        }
...
var TitleCasePipe = /** @class */ (function () {
    ...
    TitleCasePipe.prototype.transform = function (value) {
        if (!value)
            return value;
        if (typeof value !== 'string') {
            throw invalid_pipe_argument_error_1.invalidPipeArgumentError(TitleCasePipe, value);
        }
        return value.replace(unicodeWordMatch, (function (txt) { return txt[0].toUpperCase() + txt.substr(1).toLowerCase(); }));
    };
    TitleCasePipe.decorators = [
        { type: core_1.Pipe, args: [{ name: 'titlecase' },] },
    ];
...
var UpperCasePipe = /** @class */ (function () {
    ...
    UpperCasePipe.prototype.transform = function (value) {
        if (!value)
            return value;
        if (typeof value !== 'string') {
            throw invalid_pipe_argument_error_1.invalidPipeArgumentError(UpperCasePipe, value);
        }
