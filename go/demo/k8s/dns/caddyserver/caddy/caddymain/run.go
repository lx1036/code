...
import (
	...
	"io"
	"io/ioutil"
	caddy "k8s-lx1036/demo/k8s/dns/caddyserver"
	"k8s-lx1036/demo/k8s/dns/caddyserver/caddyfile"
	"k8s-lx1036/demo/k8s/dns/caddyserver/caddytls"
	"k8s-lx1036/demo/k8s/dns/caddyserver/telemetry"
	"log"
	"os"
	"path/filepath"
	"runtime"
	...
	// built-in plugins
	_ "k8s-lx1036/demo/k8s/dns/caddyserver/caddyhttp"
