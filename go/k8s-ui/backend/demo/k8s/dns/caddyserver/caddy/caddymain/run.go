...
import (
	...
	"io"
	"io/ioutil"
	caddy "k8s-lx1036/k8s-ui/backend/demo/k8s/dns/caddyserver"
	"k8s-lx1036/k8s-ui/backend/demo/k8s/dns/caddyserver/caddyfile"
	"k8s-lx1036/k8s-ui/backend/demo/k8s/dns/caddyserver/caddytls"
	...
	// built-in plugins
	_ "k8s-lx1036/k8s-ui/backend/demo/k8s/dns/caddyserver/caddyhttp"
