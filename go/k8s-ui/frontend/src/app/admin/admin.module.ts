...
@NgModule({
  declarations: [
    ...
    ApikeyComponent,
    AppComponent,
    AppReportFormComponent,
    AuditLogComponent,
    AutoscaleComponent,
    AutoscaleTplComponent,
    ClusterComponent,
    ConfigComponent,
    ConfigmapComponent,
    ConfigmapTplComponent,
    ConfigSystemComponent,
    CreateNotificationComponent,
    CronjobComponent,
    CronjobTplComponent,
    DaemonSetComponent,
    DaemonSetTplComponent,
    DeployComponent,
    DeploymentComponent,
    DeploymentTplComponent,
    ...
    TrashAutoscaleTplComponent,
    TrashAutoscaleComponent,
    TrashDaemonSetTplComponent,
    TrashDaemonSetComponent,
    TrashStatefulsetComponent,
    TrashStatefulsetTplComponent,
    TrashPersistentVolumeClaimTplComponent,
    TrashPersistentVolumeClaimComponent,
    TrashSecretComponent,
    TrashSecretTplComponent,
    TrashAppComponent,
    TrashConfigmapComponent,
    TrashConfigmapTplComponent,
    TrashCronjobComponent,
    TrashCronjobTplComponent,
    TrashClusterComponent,
    TrashDeploymentComponent,
    TrashDeploymentTplComponent,
