...
import (
	...
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/imagelocality"
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/interpodaffinity"
	...
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/nodepreferavoidpods"
	...
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/podtopologyspread"
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/queuesort"
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/tainttoleration"
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/volumebinding"
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/volumerestrictions"
	"k8s-lx1036/k8s/scheduler/pkg/framework/plugins/volumezone"
)
