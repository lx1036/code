...
import (
	...
	"k8s-lx1036/k8s/scheduler/pkg/apis/scheduling/config"
	"k8s-lx1036/k8s/scheduler/pkg/apis/scheduling/v1alpha1"
	"k8s-lx1036/k8s/scheduler/pkg/client/clientset/versioned"
	schedinformer "k8s-lx1036/k8s/scheduler/pkg/client/informers/externalversions"
	externalv1alpha1 "k8s-lx1036/k8s/scheduler/pkg/client/listers/scheduling/v1alpha1"
