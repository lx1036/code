...
import (
	...
	"k8s-lx1036/k8s/scheduler/pkg/kube-batch/cmd/app/options"
	"k8s-lx1036/k8s/scheduler/pkg/kube-batch/pkg/scheduler"
	"k8s-lx1036/k8s/scheduler/pkg/kube-batch/pkg/version"
