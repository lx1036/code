...
import (
	v1 "k8s-lx1036/k8s/scheduler/pkg/volcano/kube-batch/pkg/apis/scheduling.k9s.io/v1"
	"k8s-lx1036/k8s/scheduler/pkg/volcano/kube-batch/pkg/client/clientset/versioned/scheme"
...
// SchedulingV1Client is used to interact with features provided by the scheduling.k9s.io group.
