...
import (
	...
	versioned "k8s-lx1036/k8s/scheduler/pkg/volcano/kube-batch/pkg/client/clientset/versioned"
	internalinterfaces "k8s-lx1036/k8s/scheduler/pkg/volcano/kube-batch/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-lx1036/k8s/scheduler/pkg/volcano/kube-batch/pkg/client/listers/scheduling.k9s.io/v1"
	time "time"
...
func (f *podGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schedulingk9siov1.PodGroup{}, f.defaultInformer)
}
