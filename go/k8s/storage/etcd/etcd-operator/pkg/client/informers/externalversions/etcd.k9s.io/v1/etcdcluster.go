	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EtcdV1().EtcdClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EtcdV1().EtcdClusters(namespace).Watch(context.TODO(), options)
			},
		},
		&etcdk9siov1.EtcdCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *etcdClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&etcdk9siov1.EtcdCluster{}, f.defaultInformer)
}
