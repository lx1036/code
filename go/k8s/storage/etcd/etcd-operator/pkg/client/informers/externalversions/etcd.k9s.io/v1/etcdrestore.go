	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EtcdV1().EtcdRestores(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EtcdV1().EtcdRestores(namespace).Watch(context.TODO(), options)
			},
		},
		&etcdk9siov1.EtcdRestore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *etcdRestoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&etcdk9siov1.EtcdRestore{}, f.defaultInformer)
}
