...
import (
	"context"
	apiextensionsv1 "k8s-lx1036/k8s/apiserver/apiextension-server/pkg/apis/apiextensions/v1"
	versioned "k8s-lx1036/k8s/apiserver/apiextension-server/pkg/client/clientset/versioned"
	internalinterfaces "k8s-lx1036/k8s/apiserver/apiextension-server/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-lx1036/k8s/apiserver/apiextension-server/pkg/client/listers/apiextensions/v1"
	time "time"
