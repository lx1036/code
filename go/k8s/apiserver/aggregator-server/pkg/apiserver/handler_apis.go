...
import (
	...
	apiregistrationv1api "k8s-lx1036/k8s/apiserver/aggregator-server/pkg/apis/apiregistration/v1"
...
// INFO: e.g. http://127.0.0.1:8001/apis/metrics.k8s.io/v1beta1/nodes
...
func (r *apisHandler) ServeHTTP(w http.ResponseWriter, req *http.Request) {
	...
	responsewriters.WriteObjectNegotiated(r.codecs, negotiation.DefaultEndpointRestrictions, schema.GroupVersion{},
		w, req, http.StatusOK, discoveryGroupList)
}
...
// INFO: e.g. http://127.0.0.1:8001/apis/metrics.k8s.io/
