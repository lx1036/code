...
import (
	"context"
	v1 "k8s-lx1036/k8s/apiserver/aggregator-server/pkg/apis/apiregistration/v1"
	scheme "k8s-lx1036/k8s/apiserver/aggregator-server/pkg/client/clientset/versioned/scheme"
	"time"
