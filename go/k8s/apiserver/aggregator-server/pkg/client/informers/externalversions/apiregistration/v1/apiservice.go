...
import (
	...
	versioned "k8s-lx1036/k8s/apiserver/aggregator-server/pkg/client/clientset/versioned"
	internalinterfaces "k8s-lx1036/k8s/apiserver/aggregator-server/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-lx1036/k8s/apiserver/aggregator-server/pkg/client/listers/apiregistration/v1"
	time "time"
