...
import (
	...
	versioned "k8s-lx1036/k8s/monitor/vpa/recommender/pkg/client/clientset/versioned"
	internalinterfaces "k8s-lx1036/k8s/monitor/vpa/recommender/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-lx1036/k8s/monitor/vpa/recommender/pkg/client/listers/autoscaling.k9s.io/v1"
	time "time"
...
func NewFilteredVerticalPodAutoscalerInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&autoscalingk9siov1.VerticalPodAutoscaler{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *verticalPodAutoscalerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&autoscalingk9siov1.VerticalPodAutoscaler{}, f.defaultInformer)
}
