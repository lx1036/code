...
// TakeCPUByTopology allocate cpu by topology
func TakeCPUByTopology(topo *topology.CPUTopology, availableCPUs cpuset.CPUSet, numCPUs int) (cpuset.CPUSet, error) {
