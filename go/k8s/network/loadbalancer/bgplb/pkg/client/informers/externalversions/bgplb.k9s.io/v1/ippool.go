	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BgplbV1().IPPools().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BgplbV1().IPPools().Watch(context.TODO(), options)
			},
		},
		&bgplbk9siov1.IPPool{},
		resyncPeriod,
...
func (f *iPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bgplbk9siov1.IPPool{}, f.defaultInformer)
}
