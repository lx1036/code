...
// https://github.com/jwhited/corebgp/blob/master/examples/simple/main.go
// https://www.jordanwhited.com/posts/corebgp-plugging-in-to-bgp/

// FSM(finite-state automation): 有限状态自动机
...
// go run . --id="local-ip" --las=64512 --ras=65001 --laddr="local-ip" --raddr="remote-ip"
func main() {
	flag.Parse()
	var (
		lis net.Listener
