...
import (
	...
	versioned "k8s-lx1036/k8s/network/cilium/cilium-ipam/pkg/client/clientset/versioned"
	internalinterfaces "k8s-lx1036/k8s/network/cilium/cilium-ipam/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-lx1036/k8s/network/cilium/cilium-ipam/pkg/client/listers/ipam.k9s.io/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.IpamV1().IPPools().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IpamV1().IPPools().Watch(context.TODO(), options)
			},
		},
		&ipamk9siov1.IPPool{},
		resyncPeriod,
...
func (f *iPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ipamk9siov1.IPPool{}, f.defaultInformer)
}
